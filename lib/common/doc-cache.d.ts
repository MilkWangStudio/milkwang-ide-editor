...
export declare const IDocPersistentCacheProvider: unique symbol;
...
export declare function isDocContentCache(cache: IDocCache): cache is IDocContentCache;
export declare function isDocChangesCache(cache: IDocCache): cache is IDocChangesCache;
export declare function parseCacheValueFrom(change: IModelContentChange): IDocCacheValue;
export declare function parseRangeFrom(cacheValue: IDocCacheValue): Range;
export {};
