...
export declare abstract class ResourceService {
    /**
 ...
 */
export declare class ResourceNeedUpdateEvent extends BasicEvent<URI> {
}
export declare class ResourceDidUpdateEvent extends BasicEvent<URI> {
}
export declare class ResourceRemoveEvent extends BasicEvent<URI> {
}
export declare class ResourceDecorationChangeEvent extends BasicEvent<IResourceDecorationChangeEventPayload> {
}
...
export declare const DIFF_SCHEME = "diff";
export declare function isDiffResource(resource: IResource): resource is IDiffResource;
export declare enum AskSaveResult {
    REVERT = 1,
    SAVE = 2,
    CANCEL = 3
}
