...
export interface IEditorDocumentModel extends IDisposable {
    ...
    updateOptions(options: IDocModelUpdateOptions): any;
}
...
export interface IEditorDocumentModelService {
     ...
     * @param options
     */
    changeModelOptions(uri: URI, options: IPreferredModelOptions): any;
...
export declare const IEditorDocumentModelService: unique symbol;
...
export declare const IEditorDocumentModelContentRegistry: unique symbol;
export declare class EditorDocumentModelContentChangedEvent extends BasicEvent<IEditorDocumentModelContentChangedEventPayload> {
}
...
export declare class EditorDocumentModelOptionChangedEvent extends BasicEvent<IEditorDocumentModelOptionChangedEventPayload> {
}
export declare class EditorDocumentModelOptionExternalUpdatedEvent extends BasicEvent<URI> {
}
...
export declare class EditorDocumentModelCreationEvent extends BasicEvent<IEditorDocumentModelCreationEventPayload> {
}
...
export declare class EditorDocumentModelRemovalEvent extends BasicEvent<URI> {
}
export declare class EditorDocumentModelSavedEvent extends BasicEvent<URI> {
}
export declare class EditorDocumentModelWillSaveEvent extends BasicEvent<{
    uri: URI;
    reason: SaveReason;
    language: string;
}> {
...
export declare const ORIGINAL_DOC_SCHEME = "original_doc";
