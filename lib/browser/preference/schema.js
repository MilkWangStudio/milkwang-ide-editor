...
exports.EDITOR_SUGGEST_DEFAULTS = {
    insertMode: 'insert',
    filterGraceful: true,
...
exports.EDITOR_INLINE_SUGGEST_DEFAULTS = {
    enabled: true,
};
exports.EDITOR_DEFAULTS = {
    ...
    wrappingIndent: 1 /* WrappingIndent.Same */,
    ...
    viewInfo: {
        ...
        rulers: [],
        ariaLabel: (0, ide_core_browser_1.localize)('editorViewAccessibleLabel', 'Editor content'),
        renderLineNumbers: 0,
...
const customEditorSchema = {
    ...
    'editor.tabSize': {
        type: 'number',
        default: exports.EDITOR_FONT_DEFAULTS.tabSize,
        minimum: 1,
    ...
    'editor.renderWhitespace': {
        type: 'boolean',
        default: exports.EDITOR_FONT_DEFAULTS.renderWhitespace,
    },
    'editor.cursorStyle': {
        type: 'string',
    ...
    'editor.insertSpaces': {
        type: 'boolean',
        default: exports.EDITOR_FONT_DEFAULTS.insertSpace,
    },
    'editor.wordWrap': {
        type: 'string',
        enum: ['off', 'on'],
    ...
    'editor.wordWrapColumn': {
        type: 'number',
        default: exports.EDITOR_FONT_DEFAULTS.wordWrapColumn,
